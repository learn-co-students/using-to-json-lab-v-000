...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :inventory => Faker::Number.between(1,100), :description => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit a rem reprehenderit necessitatibus saepe facilis maxime suscipit fugiat. Illo doloremque quidem similique iusto aliquid repellat id, reiciendis vel ducimus laboriosam?")
end
5.times do
